  ...
  */
  ...
  var createPicture = function (picture) {
    ...
    pictureElement.addEventListener('click', function () {
      window.preview.openBigPicture(picture);
    });
  ...
  var hideComments = function () {
    window.preview.bigPicture.querySelector('.social__comment-count').classList.add('visually-hidden');
    window.preview.bigPicture.querySelector('.comments-loader').classList.add('visually-hidden');
  };
